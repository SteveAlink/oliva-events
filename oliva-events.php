 ...
 *
 * Shows one or more calendars with events or availability
 */
...
{
    $css = '<link rel="stylesheet" href="' . olivaEventsPluginBasePath() . 'css/style.css">' . PHP_EOL;
...
{
    $js = '<script src="' . olivaEventsPluginBasePath() . 'js/oliva-events.js"></script>' . PHP_EOL;
